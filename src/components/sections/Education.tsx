    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        ...
        <motion.div
          ...
          viewport={{ once: false }}
          className="mt-16 bg-bg-secondary/40 border border-accent-muted/15 rounded-lg p-10 hover:border-accent-primary/40 transition-all"
        >
          <h3 className="text-2xl font-black text-accent-default mb-2">
